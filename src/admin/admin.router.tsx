...
const AdminCategoryPage = lazy(
  () => import('./pages/category/AdminCategoryPage')
);
...
const AdminOrdersPage = lazy(() => import('./pages/orders/AdminOrdersPage'));
const AdminOrderPage = lazy(() => import('./pages/order/AdminOrderPage'));
